...
// social links
export const twitterLink = 'https://twitter.com/MohammadAhmerMK'
export const githubLink = 'https://github.com/MohammadAhmerMalick'
export const githubGistLink = 'https://gist.github.com/MohammadAhmerMalick'
export const linkedinLink = 'https://www.linkedin.com/in/mohammadahmermalick'
